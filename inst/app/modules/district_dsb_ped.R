...
observe({
  ped_total_collision <- ped_total_collision()
  ped_total_casualty <- ped_total_casualty()
  ped_serious_stat <- ped_serious_stat()
  ped_fatal_stat <- ped_fatal_stat()
})
